...
public interface Ministry_StoreRepository extends JpaRepository<Ministry_Store,Long> {

    @Query(value="select *from ministry_store u where m_store_id = :m_store_id",nativeQuery=true)
    public Ministry_Store findByM_store_id(@Param("m_store_id") Long m_store_id);
}
