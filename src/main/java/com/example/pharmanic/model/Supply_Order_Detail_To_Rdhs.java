...
public class Supply_Order_Detail_To_Rdhs {
    ...
    public Supply_Order_Detail_To_Rdhs(Long id, Supply_Order_To_Rdhs order_id, Medicine sr_no, String drug_name, Long quantity, Date date) {
        this.id = id;
    ...
    public String toString() {
        return "Supply_Order_Detail_To_Rdhs{" +
                "id=" + id +
                ", order_id=" + order_id +
                ", sr_no=" + sr_no +
                ", drug_name='" + drug_name + '\'' +
